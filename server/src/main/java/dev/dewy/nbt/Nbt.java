...
public class Nbt {
    ...
    public void toNetworkStream(@NonNull CompoundTag compound, @NonNull DataOutput output) throws IOException {
        this.writer.toNetworkStream(compound, output);
    }
    ...
    public byte[] toNetworkByteArray(@NonNull CompoundTag compound) throws IOException {
        @Cleanup ByteArrayOutputStream baos = new ByteArrayOutputStream();
        @Cleanup DataOutputStream w = new DataOutputStream(baos);

        this.toNetworkStream(compound, w);
