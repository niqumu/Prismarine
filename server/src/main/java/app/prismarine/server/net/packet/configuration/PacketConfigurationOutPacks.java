...
@Data
public class PacketConfigurationOutPacks implements Packet {

	private List<Pack> packs = new ArrayList<>();

	public PacketConfigurationOutPacks(String namespace, String id, String version) {
		this.packs.add(new Pack(namespace, id, version));
	}

	public PacketConfigurationOutPacks(ByteBufWrapper bytes) {
